    ...
    <#if section = "header">
        <div class="edu-header">
            <div class="edu-logo-wrapper">
                ...
                <div class="edu-brand">
                    <span class="edu-brand-name">Ape <span class="edu-brand-accent">Iskole</span></span>
                    <span class="edu-brand-tagline">Educational Platform</span>
                </div>
            </div>
    ...
    <#elseif section = "form">
        <form id="kc-register-form" action="${url.registrationAction}" method="post" class="edu-form">
            <div class="edu-form-group">
                <label for="firstName" class="edu-label">Full Name</label>
            ...
            <div class="edu-form-group">
                <label class="edu-label">I am a ...</label>
                <div class="edu-checkbox-row">
                    <input type="radio" id="student_yes" name="user.attributes.is_student" value="true" checked />
                    <label for="student_yes">Student</label>
                    <input type="radio" id="student_no" name="user.attributes.is_student" value="false" />
                    <label for="student_no">Teacher / Parent</label>
                </div>
            </div>
        ...
        <div class="edu-footer">
            ...
            <p class="edu-copyright">© 2025 Ape Iskole. All rights reserved.</p>
        </div>
    </#if>
