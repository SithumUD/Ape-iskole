...
<@layout.emailLayout>
    <#assign subject = msg("emailVerificationSubject")>
    <#assign subject = "Verify Your Email Address - EduTrack Pro">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px;">
                ...
                <tr>
                    <td align="center" style="padding-bottom: 30px;">
                        <p style="margin: 0; font-size: 12px; color: #6b7280; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600;">
                ...
                <tr>
                    <td style="padding: 40px 40px 30px;">
                        ...
                        <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4b5563; text-align: center;">
                            Welcome to <strong>EduTrack Pro</strong>! Please verify your email address to complete your account setup and start using our school management system.
                        </p>
                        <p style="margin: 0 0 32px; font-size: 15px; line-height: 1.6; color: #6b7280; text-align: center;">
                            Click the button below to verify your email address. This link will expire in <strong>${linkExpiration}</strong>.
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 20px; background: #f9fafb; border-radius: 12px; border-left: 4px solid #6366f1;">
                        <p style="margin: 0; font-size: 13px; line-height: 1.6; color: #6b7280;">
                            <strong style="color: #111827;">Security Notice:</strong> If you didn't create an account with EduTrack Pro, please ignore this email. This verification link will expire automatically.
                        </p>
                    </td>
                </tr>
            </table>
