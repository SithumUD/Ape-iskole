...
<@layout.emailLayout>
    <#assign subject = "Email Address Changed - EduTrack Pro">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px;">
                <tr>
                    <td align="center" style="padding-bottom: 20px;">
                        <div style="width: 56px; height: 56px; background: linear-gradient(135deg, #6366f1, #4f46e5); border-radius: 14px; display: inline-block; box-shadow: 0 8px 24px -6px rgba(99, 102, 241, 0.5);">
                            <svg width="32" height="32" viewBox="0 0 24 24" style="margin: 12px;" fill="white">
                                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; background: #ffffff; border-radius: 20px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08);">
                <tr>
                    <td style="padding: 40px 40px 30px;">
                        ...
                        <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4b5563; text-align: center;">
                            The email address associated with your <strong>EduTrack Pro</strong> account has been successfully updated.
                        </p>
                        <#if event.date??>
                            ...
                            <tr>
                                <td>
                                    <p style="margin: 0; font-size: 14px; color: #111827;">
                                        <strong>New Email Address:</strong> ${user.email}
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="padding: 20px; background: #fef2f2; border-radius: 12px; border-left: 4px solid #ef4444;">
                        <p style="margin: 0; font-size: 13px; line-height: 1.6; color: #6b7280;">
                            <strong style="color: #dc2626;">Security Alert:</strong> If you didn't change your email address, please contact our support team immediately. Your account may have been compromised.
                        </p>
                    </td>
                </tr>
            </table>
