...
<@layout.emailLayout>
    <#assign subject = msg("emailForgotPasswordSubject")>
    <#assign subject = "Reset Your Password - EduTrack Pro">
                ...
                <tr>
                    <td style="padding: 40px 40px 30px;">
                        ...
                        <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4b5563; text-align: center;">
                            We received a request to reset your password for your <strong>EduTrack Pro</strong> account. If you made this request, click the button below to create a new password.
                        </p>
                        <p style="margin: 0 0 32px; font-size: 15px; line-height: 1.6; color: #6b7280; text-align: center;">
                            This password reset link will expire in <strong>${linkExpiration}</strong>. For security reasons, please use it as soon as possible.
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 20px; background: #fef2f2; border-radius: 12px; border-left: 4px solid #ef4444;">
                        <p style="margin: 0; font-size: 13px; line-height: 1.6; color: #6b7280;">
                            <strong style="color: #dc2626;">Important:</strong> If you didn't request a password reset, please ignore this email. Your password will remain unchanged. If you're concerned about your account security, please contact our support team immediately.
                        </p>
                    </td>
                </tr>
            </table>
